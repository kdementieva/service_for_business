...
from .views import CompanyCreateView, CompanyDetailView, StorageCreateView, StorageDetailView, SupplierListCreateView, SupplierDetailView, SupplyListCreateView, SupplyDetailView, ProductListCreateView, ProductDetailView
